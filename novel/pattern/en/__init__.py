...
from novel.pattern.tree import (
...
from novel.pattern.en.inflect import (
...
from novel.pattern.en.inflect_quantify import (
    number, numerals, quantify, reflect
)
# Import mood & modality functions.
from novel.pattern.en.modality import (
    mood, INDICATIVE, IMPERATIVE, CONDITIONAL, SUBJUNCTIVE,
    modality, uncertain, EPISTEMIC,
    negated
)
# Import all submodules.
from novel.pattern.en import inflect
from novel.pattern.en import wordnet
from novel.pattern.en import wordlist
